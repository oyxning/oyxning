<!-- 首页大图：全宽展示 -->
<p align="center">
  <img src="https://raw.githubusercontent.com/oyxning/oyxning/refs/heads/main/jieshu.jpg" alt="LumineStory Banner" width="100%" style="border-radius: 12px; box-shadow: 0 4px 24px #e1eaff;" />
</p>
...
<p align="center" style="font-family: 'ZCOOL KuaiLe', 'Comic Sans MS', cursive; font-size: 1.05em; color: #ffb6c1;">
  ...
  🪄 技术是魔法，代码是咒语，和小伙伴们一起创造属于我们的二次元世界！
</p>
...
<div align="center" style="font-family: 'ZCOOL KuaiLe', 'Comic Sans MS', cursive; color: #a3a3ff; font-size: 1.08em; background: linear-gradient(90deg, #f8e1ff 0%, #e1f0ff 100%); border-radius: 12px; padding: 16px; margin-bottom: 10px; max-width: 700px;">
  <p>✧ 编程是我的魔法，代码是我的魔杖。<br>
  ✧ 喜欢在深夜与猫猫一起debug，像主角一样在二次元世界冒险。<br>
  ✧ 用技术和创意，构建属于自己的治愈系幻想乡。<br>
  ✧ 相信每一行代码都能点亮世界的一角，每一次commit都是成长的足迹。<br>
  ✧ 让生活和梦想都充满二次元的色彩与温度！<br>
  ✧ 代码和梦想都要闪闪发光，像魔法少女一样勇敢前行！<br>
  ✧ 希望和更多同好一起组队冒险，创造属于我们的二次元传说！</p>
</div>
